module atmosphere_mod
   ...
   use mpp_mod, only: mpp_pe, mpp_root_pe, mpp_chksum ! debug_pjp
...
!=================================================================================================================================
   ...
   character(len=128) :: version= &
      '$Id: atmosphere.f90,v 11.0 2004/09/28 19:29:08 fms Exp $'
...
!=================================================================================================================================
   subroutine print_chksums ! debug_pjp
      integer(kind=8) :: iug, ivg, itg, ipsg, itr1, itr2, iwg

      iug  = mpp_chksum(ug)
      ivg  = mpp_chksum(vg)
      itg  = mpp_chksum(tg)
      ipsg = mpp_chksum(psg)
      itr1 = mpp_chksum(grid_tracers(:,:,:,:,1))
      itr2 = mpp_chksum(grid_tracers(:,:,:,:,2))
      iwg  = mpp_chksum(wg_full)
      if(mpp_pe() == mpp_root_pe()) then
         print '("mpp_chksum(ug) =",z17)',iug
         print '("mpp_chksum(vg) =",z17)',ivg
         print '("mpp_chksum(tg) =",z17)',itg
         print '("mpp_chksum(psg)=",z17)',ipsg
         print '("mpp_chksum(tr1)=",z17)',itr1
         print '("mpp_chksum(tr2)=",z17)',itr2
         print '("mpp_chksum(wg) =",z17)',iwg
      endif

   end subroutine print_chksums
!=================================================================================================================================
